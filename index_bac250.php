...
$APPLICATION->SetPageProperty("description", "Хотите купить детские колготки оптом по недорогим ценам? Компания «Лукоморье» продает дешевые колготы и носки для детей оптом и в розницу со склада в городах по всей России. Лучшие цены на колготки оптом в Москве - от 123 рублей. Гарантия качества! Собственное производство!");
$APPLICATION->SetPageProperty("title", "Детские колготки оптом в Москве, детские носки и колготы от производителя со склада по низким ценам");
...
<div class="CHAPTER descr_block"> 	<?$APPLICATION->IncludeFile("/include_areas/index_second_text.php", Array(), Array());?> </div>
...
<div class="main_info">
  <div class="main_map">
    ...
    <div class="orange-block">
      ...
      <p style="font-size: 13px;">Посмотреть карту <a href="http://l-ktm.ru/contacts/roznichnie_tochki/moskva/" >розничных точек по Москве</a></p>
      <p style="font-size: 13px;">Посмотреть карту <a href="http://l-ktm.ru/contacts/roznichnie_tochki/" >розничных точек по России</a></p>
