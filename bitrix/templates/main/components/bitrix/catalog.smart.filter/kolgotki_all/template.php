    ...
    <div class="bx_filter_section m4">
        ...
        <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
            ...
            <? foreach ($arResult["ITEMS"] as $key => $arItem): ?>
                ...
                <div class="bx_filter_container active">
                    ...
                    <span class="bx_filter_container_title">
                        <span class="bx_filter_container_modef"></span><?= $arItem["NAME"] ?>
                    </span>
                    <div class="bx_filter_block">
                        <? foreach ($arItem["VALUES"] as $val => $ar): ?>
                            <span class="<? echo $ar["DISABLED"] ? ' disabled' : 'bx_filter_block_span' ?>">
							<input type="checkbox" value="<? echo $ar["HTML_VALUE"] ?>"
                                   name="<? echo $ar["CONTROL_NAME"] ?>" id="<? echo $ar["CONTROL_ID"] ?>"
                                <? echo $ar["CHECKED"] ? 'checked="checked"' : '' ?>
                                   onclick="smartFilter.click(this)"
                                   <? if ($ar["DISABLED"]): ?>disabled<? endif ?>
                                    style="display: none;"
                            />
							<label <? echo $ar["CHECKED"] ? 'class="activated"' : '' ?> for="<? echo $ar["CONTROL_ID"] ?>" onclick="activated(this)"><? echo $ar["VALUE"]; ?></label>
						</span>
                        <? endforeach; ?>
                    </div>
                </div>
            ...
            <div class="bx_filter_control_section">
                ...
                <?/*<div class="bx_filter_popup_result rught"
