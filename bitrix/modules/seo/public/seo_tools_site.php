...
//HTML output
$aTabs = array(
	array("DIV" => "edit1", "TAB" => '��������', "ICON" => "main_settings", "TITLE" => '�������� '.$back_url),
	array("DIV" => "edit5", "TAB" => '����������', "ICON" => "main_settings", "TITLE" => '���������� ����������'),
	array("DIV" => "edit2", "TAB" => '����������', "ICON" => "main_settings", "TITLE" => '����������'),
	array("DIV" => "edit3", "TAB" => '��������', "ICON" => "main_settings", "TITLE" => '�������� � �����������'),
	array("DIV" => "edit4", "TAB" => '����������� �����', "ICON" => "main_settings", "TITLE" => '����������� �����'),
);
...
?>
<tr>
	<td width="40%">��������: <a href="javascript:alert('no help yet')">[?]</a>: </td>
	<td width="60%"><?echo $counters;?></td>
</tr>
<?endif;?>
</table>
<table id="bx_stats_loading_notify" class="edit-table"><tr><td align="center"><?ShowNote('�������� ���������� � ��������...');?></td></tr></table>
...
<tr>
	<td colspan="2">
		<a href="javascript:void(0)" onclick="BXToggle('bx_page_extended_data'); return false;">���������</a>
...
?>
<tr>
	<td>������� ��������� �������� <a href="javascript:alert('no help yet')">[?]</a>: </td>
...
?>
<tr>
	<td valign="top">������� ��������� �������� <a href="javascript:alert('no help yet')">[?]</a>: </td>
	<td>
...
?>
	<tr>
		<td>��� ������������� ������ ������� ���������� ������ ������ ������������ ��������� ������ � <a href="/bitrix/admin/settings.php?mid=seo&tabControl_active_tab=edit3">���������� ������ SEO</a>.</td>
	</tr>
<?
	else:
...
?>
	<tr class="heading">
		<td colspan="2">��������� �������, ��������������� �������� �� ��������� <?echo $days_count?> ����</td>
	</tr>
<?
...
?>
		<tr>
			<td align="left" width="30%"><a href="javascript:void(0)" onclick="BXToggle('bx_phrase_ex_<? echo $arData['ID']?>'); return false;" title="��������� ���������� �� ���������"><?echo htmlspecialchars($word)?></td>
			<td width="70%">
...
?>
		...
		<td colspan="2" align="right"><a href="/bitrix/admin/phrase_list.php?lang=<?echo LANGUAGE_ID?>">���������� � ������ ����������</a></td>
	</tr>
<?
	}
...
?>
		<tr>
			<td width="30%" align="left"><a href="javascript:void(0)" onclick="BXToggle('bx_referer_ex_<?echo CUtil::JSEscape($domain)?>'); return false;" title="��������� ���������� �� �������"><?echo htmlspecialchars($domain)?></td>
			<td width="70%">
...
?>
	...
	<td colspan="2" align="right"><a href="/bitrix/admin/referer_list.php?lang=<?echo LANGUAGE_ID?>">���������� � ������ ����������</a></td>
</tr>
<?
	}
