...
//error_reporting(E_ALL ^ E_NOTICE);
        ...
        define('CONFIG_UPLOAD_MAXSIZE', 8 * 2048 * 2048); //by bytes
        ...
        define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,jpeg,png,bmp,tif,zip,php,sit,rar,gz,tar,htm,html,mov,mpg,avi,asf,mpeg,wmv,aif,aiff,wav,mp3,swf,ppt,rtf,doc,pdf,xls,txt,xml,xsl,dtd');//
