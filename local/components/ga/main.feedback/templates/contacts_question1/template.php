...
<div id="contacts_form" class="mfeedback" style="margin-top: 10px;">
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST">
		...
		<div class="mf-name">
			<div class="mf-text">
				Вопрос<?if(empty($arParams["REQUIRED_FIELDS"]) || in_array("QUESTION", $arParams["REQUIRED_FIELDS"])):?><span class="mf-req">*</span><?endif?>
			</div>
			<textarea rows="10" cols="67" name="user_question"><?=$arResult["AUTHOR_QUESTION"]?></textarea>
		</div><br />
