...
while ($arRes = $db_iblock->Fetch()) {
    ...
    $db_iblock_section = CIBlockSection::GetList(Array("SORT" => "ASC"), Array("ACTIVE" => "Y", "IBlOCK_ID" => $arRes["ID"]), array("NAME", "IBlOCK_ID", "ID"));
    while ($arSecRes = $db_iblock_section->Fetch()) {
        $arSectionIBlocks[$arSecRes["ID"]] = $arSecRes["NAME"];
    }
}
