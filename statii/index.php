...
$APPLICATION->SetPageProperty("SECOND_TITLE", "Лукоморье. Продажа детской одежды - Статьи");
...
$APPLICATION->SetPageProperty("title", "Статьи – Лукоморье");
$APPLICATION->SetTitle("Статьи");
?><?$APPLICATION->IncludeComponent("bitrix:news", "statii", array(
	"IBLOCK_TYPE" => "news",
	"IBLOCK_ID" => "3",
	"NEWS_COUNT" => "50",
	"USE_SEARCH" => "N",
